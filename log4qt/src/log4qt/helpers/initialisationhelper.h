...
namespace Log4Qt
{
     ...
     * type \a TYPE. The pointer is set using q_atomic_test_and_set_ptr(). The
     * threads that find the pointer already been set will delete their object.
     * The singleton object will not be deleted during static 
     * deinintialisation.
     * 
	 ...
	 * static initinitialisation. It will capture the programs startup time, 
