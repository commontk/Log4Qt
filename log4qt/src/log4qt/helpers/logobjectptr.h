...
{	
	...
	public:
		 ...
		 * object the LogObjectPtr pointed to before the assignement is
		...
		/*!
		 * Assignement operator. Sets the LogObject pointer to point to the 
		 * object \a pLogObject. The reference counter of the object the 
		 * LogObjectPtr pointed to before the assignement is decremented by 
